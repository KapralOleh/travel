    ...
    if ( ! class_exists( 'ReduxFramework_Extension_options_object' ) ) {
        ...
        class ReduxFramework_Extension_options_object {
            ...
            public function overload_field_path( $field ) {
                return get_template_directory() . '/highgrade/framework/inc/extensions/options_object/' . $this->field_name . '/field_' . $this->field_name . '.php';
            }
        } // class
    } // if
