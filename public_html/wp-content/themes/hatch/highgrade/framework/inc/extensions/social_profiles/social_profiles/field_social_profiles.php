        ...
        class ReduxFramework_social_profiles {
            ...
            public function __construct( $field = array(), $value = '', $parent ) {
                ...
                if ( empty( $this->extension_dir ) ) {
                    $this->extension_dir = trailingslashit( str_replace( '\\', '/', get_template_directory() . '/highgrade/framework/inc/extensions/social_profiles' ) );
            ...
            public function render() {
                ...
                $msg      = isset( $this->field['widget_msg'] ) ? $this->field['widget_msg'] : __( 'Go to the <a href="%s">Widgets</a> page to add the Redux Social Widget to any active widget area.', 'hatch' );
                ...
                foreach ( $this->defaults as $key => $social_provider_default ) {
                    ...
                    $label = ( $social_provider_option && array_key_exists( 'label', $social_provider_option ) && $social_provider_option['label'] ) ? $social_provider_option['label'] : __( 'Link URL', 'hatch' ); //$social_provider_default[ 'name' ];
                ...
                />';
                    ...
                    $reset_text = __( 'Reset', 'hatch' );
                    echo '<div class="redux-social-profiles-item-reset">';
                    echo '<a class="button" data-value="' . $key . '" value="' . $reset_text . '" />' . $reset_text . '</a>';
                    echo '</div>';

                    /*$label = apply_filters('redux/extensions/social_profiles/' . $this->opt_name . '/color_picker/text', __( 'Text', 'hatch' ));
                    ...
                    /*$label = apply_filters('redux/extensions/social_profiles/' . $this->opt_name . '/color_picker/background', __( 'Background', 'hatch' ));
