    ...
    class reduxSocialWidgetDisplay extends WP_Widget {
        ...
        public function __construct ($params) {
            ...
            $widget_ops = array(
                ...
                'description'   => __ ( 'Display social media links', 'hatch' )
            );
...
<?php 
                    ...
                    printf ( __ ( 'Control which icons are displayed and their urls on the %ssettings page%s', 'hatch' ), '<a href="' . admin_url ( 'admin.php?page=' . $slug . '&tab=' . $tab ) . '">', '</a>' ); 
?>
                </label>
            </p>
<?php
