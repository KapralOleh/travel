...
<div class="row blog blogPosts <?php echo (isset($hgr_options['blog_color_scheme']) ? $hgr_options['blog_color_scheme'] : '');?>">
  <div class="container"> 
    ...
    <div class="col-md-9">
      ...
      <h1 class="titleSep"><?php esc_html_e( 'Daily Archives:', 'hatch' );?>
        <?php the_time( 'F jS, Y' ); ?>
      </h1>
      <?php /* If this is a monthly archive */ } elseif ( is_month() ) { ?>
      <h1 class="titleSep"><?php esc_html_e( 'Monthly Archives:', 'hatch' );?>
        <?php the_time( 'F, Y' ); ?>
      </h1>
      <?php /* If this is a yearly archive */ } elseif ( is_year() ) { ?>
      <h1 class="titleSep"><?php esc_html_e( 'Yearly Archives:', 'hatch' );?>
        <?php the_time( 'Y' ); ?>
      </h1>
      <?php } ?>
